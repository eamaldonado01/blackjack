// MultiPlayerGame.jsx – existing multiplayer flow extracted from old App.jsx
// path: blackback/client/src/MultiPlayerGame.jsx
...
async function handleNewRound() {
  ...
  try {
    ...
    await resp.json();
    setBalance(data.balance); // NEW: Sync balance from server
    const data = await resp.json(); 
